...
public class PowerUp_TripleShot : PowerUpBase
{
    ...
    {
        BulletsPool.Instance.InitBullet(shipBase.shootRoot2, shipBase._properties, Enums.TypeBullet.player);
        BulletsPool.Instance.InitBullet(shipBase.shootRoot1, shipBase.shootRoot3, shipBase._properties, Enums.TypeBullet.player);
    }
}